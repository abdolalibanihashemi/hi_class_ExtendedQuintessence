 ...
 */
 ...
 enum target_names {theta_s, theta_s_100, Omega_dcdmdr, omega_dcdmdr, Omega_scf, Omega_ini_dcdm, omega_ini_dcdm, Omega_smg, M2_today_smg,G_eff_today_smg, sigma8, S8}; //EQ EQGeff
 /* Important: Keep this number equal to the number of target_names (except sigma8) */
 #define _NUM_TARGETS_ 10 //EQ EQGeff
