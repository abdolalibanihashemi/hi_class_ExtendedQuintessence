...
int gravity_functions_As_from_alphas_smg(
  ...
  // below numerical precision
	if (pvecback[pba->index_bg_cs2num_smg] == pvecback[pba->index_bg_kinetic_D_smg]) {
		...
		pvecback[pba->index_bg_cs2_smg] = 1.; //Because in the case of EQs, this is identically true. //pvecback[pba->index_bg_cs2num_smg]/pvecback[pba->index_bg_kinetic_D_smg];
	}

  // NOTE:  and slip are calculated for Horndeski. Consider extending them to
  // beyond Horndeski
